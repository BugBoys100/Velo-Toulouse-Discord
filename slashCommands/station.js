...
module.exports = {
    name: "station", //the command name for the Slash Command
    description: "Envoie des infos sur une station Vélo Toulouse", //the command description for Slash Command Overview
    cooldown: 5,
        ...
        try {
            ...
            request(lien, options_json, (error, res, body) => {
                ...
                if (!error && res.statusCode == 200) {
                    send = false
                    for (key in body) {
                        if (body[key]['name'].slice(8) == station.toUpperCase()) {
