...
module.exports = client => {
  ...
  try{
    try{
      ...
      console.log(`     ┃ `.bold.brightGreen + `Le bot Discord est en ligne !`.bold.brightGreen + " ".repeat(-1+stringlength-` ┃ `.length-`Le bot Discord est en ligne !`.length)+ "┃".bold.brightGreen)
